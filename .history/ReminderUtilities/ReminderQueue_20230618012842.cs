namespace ReminderUtilities
{
    ...
    public class ReminderQueue
    {
        ...
        /// </summary>
        /// <param name="authorId">Discord user id.</param>
        /// <param name="messageChannelId">Discord text channel id.</param>
        /// <param name="messageContent">Discord message content.</param>
