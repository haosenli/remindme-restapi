namespace ReminderUtilities
{
    ...
    public class ReminderQueue
    {
        ...
        public void addReminder(string authorId, string messageChannelId, string messageContent, string utcTime)
        {
            Reminder newReminder = new Reminder(authorId, messageChannelId, messageContent, utcTime);
            var timePriority = DateTime.Parse(newReminder.utcTime);
